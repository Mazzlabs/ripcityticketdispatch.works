...
const BlackjackGame = () => {
  ...
  const getGameStatusMessage = () => {
    switch (gameState.gameStatus) {
      ...
      case 'playing':
        return { text: 'Your Turn', color: 'text-blue-400' };
      default:
  ...
  return (
    <div className="bg-green-800 rounded-xl p-8 min-h-[600px]">
      ...
      {/* Stake.us Promotion */}
      <div className="mt-8 bg-gradient-to-r from-blue-600/20 to-purple-600/20 backdrop-blur-md rounded-lg p-6 border border-white/20 text-center">
        <p className="text-blue-200 mb-4">
          Love this game? Play for real money at Stake.us!
        </p>
        <a
          href="https://stake.us/casino/live/blackjack?c=RIPCITYTICKETS"
          target="_blank"
