...
const DiceGame = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-red-800 to-rose-800 rounded-xl p-8 min-h-[600px]">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-rose-600/20 rounded-lg p-4 text-center border border-rose-500/30">
          <div className="text-2xl font-bold text-rose-400">{gameState.totalGames}</div>
          <div className="text-rose-200 text-sm">Total Games</div>
        </div>
      ...
      <div className="max-w-md mx-auto space-y-6 mb-8">
        ...
        <div>
          ...
          <div className="flex justify-between text-sm text-rose-200 mt-1">
            <span>10</span>
        ...
        <div>
          ...
          <p className="text-rose-200 text-sm mt-1">{getBetTypeDescription()}</p>
        </div>
      ...
      <div className="text-center mb-6">
        <motion.button
          ...
          className="bg-gradient-to-r from-red-600 to-rose-600 hover:from-red-700 hover:to-rose-700 disabled:from-gray-600 disabled:to-gray-700 disabled:cursor-not-allowed text-white px-12 py-4 rounded-lg font-bold text-lg transition-all duration-300"
        >
      ...
      <div className="text-center mb-6">
        <motion.button
          ...
          onClick={startNewGame}
          disabled={loading}
          className="bg-rose-600 hover:bg-rose-700 disabled:bg-gray-600 text-white px-6 py-2 rounded-lg font-semibold transition-colors"
        >
