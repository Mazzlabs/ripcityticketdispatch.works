...
const RPSGame = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-purple-800 to-rose-800 rounded-xl p-8 min-h-[600px]">
      ...
      <div className="grid grid-cols-3 gap-4 mb-8">
        ...
        <div className="bg-white/10 rounded-lg p-4 text-center border border-white/20">
          ...
          <div className="text-rose-200">Rounds</div>
        </div>
        ...
        <div className="grid grid-cols-3 gap-4 max-w-md mx-auto">
          {moves.map((move) => (
            <motion.button
              ...
              disabled={loading}
              className={`bg-white/10 hover:bg-white/20 disabled:bg-gray-600/50 disabled:cursor-not-allowed border border-white/20 hover:border-rose-400/50 rounded-lg p-6 text-center transition-all duration-300 ${
                selectedMove === move.id ? 'ring-2 ring-rose-400' : ''
              }`}
            >
      ...
      {/* Game Info */}
      <div className="text-center text-rose-200 text-sm mb-6">
        <p className="mb-2">
      ...
      {/* Stake.us Promotion */}
      <div className="bg-gradient-to-r from-rose-600/20 to-purple-600/20 backdrop-blur-md rounded-lg p-6 border border-white/20 text-center">
